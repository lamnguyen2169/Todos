...
class DoneTaskController extends BaseController implements DataObserver {
  ...
  /// MARK: - Constructors
  DoneTaskController([BaseController? parent]) : super(parent) {
    _registerObserver();
    _fetchTasks();
  }
  ...
  void dispatchEvent(BaseEvent event) {
    ...
    if (event is DoneTaskEvent) {
      _handleTaskUndone(event.task);
    } else if (event is DoneTaskDeleteEvent) {
  ...
  void _fetchTasks() {
    Rx.fromCallable(() => _taskService.fetchDoneTasks())
